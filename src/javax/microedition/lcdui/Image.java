...
public class Image {
	...
	public static Image createImage(int w, int h) {
		...
		java.awt.Image img =
			ApplicationManager.manager.awtContainer.createImage(w, h);
		java.awt.Graphics g = img.getGraphics();
		g.setColor(ApplicationManager.manager.bgColor);
		g.fillRect(0, 0, w, h);
	...
	public static Image createImage(byte[] data, int start, int len) {
		...
		return new Image(
			ApplicationManager.manager.createImage(data, start, len),
	...
	public static Image createImage(String name) throws IOException {
		return
			new Image(ApplicationManager.manager.getImage(name), false, true, name);
	}
	 ...
	 */
	public int getWidth() {
		return ApplicationManager.manager.getImageWidth(_image, name);
	}
	...
	public int getHeight() {
		return ApplicationManager.manager.getImageHeight(_image, name);
	}
	...
	public static Image createImage(InputStream stream) throws IOException {
		...
		Image img =
			new Image(
				ApplicationManager.manager.createImage(stream),
				false, true,
	...
	public static Image createRGBImage(
		...
		return new Image(
			java.awt.Toolkit.getDefaultToolkit().createImage(mis),
			false, true,
			"createRGBImage");
	}
