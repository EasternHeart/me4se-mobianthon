...
public abstract class Canvas extends Displayable {
     ...
     * @ME4SE INTERNAL
     */
    protected boolean _fullScreenMode =  ApplicationManager.manager.getFlag("canvasHideSoftButtons");
    ...
    protected Canvas() {
        ...
        if(ApplicationManager.manager.getFlag("SiemensCK")){
    ...
    public int getGameAction(int keyCode) {
    		return ApplicationManager.manager.getGameAction(keyCode);
    }
    ...
    public int getKeyCode(int game) {
    	...
    	return ApplicationManager.manager.getKeyCode(name);
    }
