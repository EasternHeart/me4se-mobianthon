...
//						mg.stale = true;
	...
	public boolean keyPressed(String code) {
        ...
        int kc = ApplicationManager.manager.getKeyCode(code);
        ApplicationManager.manager.keyStates |= getKeyFlag(kc);
	...
	public boolean keyRepeated(String code) {
		...
		canvas.keyRepeated(ApplicationManager.manager.getKeyCode(code));        	
