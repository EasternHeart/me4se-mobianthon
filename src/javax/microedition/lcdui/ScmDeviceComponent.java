 ...
 * TODO: avoiding direct access to variables etc for SCM
 * @ME4SE INTERNAL
 */
public class ScmDeviceComponent extends ScmComponent {
    ...
    String type;
    /** The Item that owns this device component. null if directly owned by a displayable */
    public Item item;  
    ...
    public boolean keyPressed(String code) {
        ...
        /*
        System.out.println("y:"+getY()+ " h:"+getHeight()+" py:"+parent.getY()+ " gpy:"+grandParent.getY()+" gph:"+grandParent.getHeight());
        
        already handled elsewhere... 
        
        if(dir == 1 && getY()+ getHeight() > parent.getY() + grandParent.getHeight()){
        	parent.setY(parent.getY() - 10);
        	return true;
        }*/
    ...
    public void focusGained() {
        System.out.println("Focus gained called for: "+this);
