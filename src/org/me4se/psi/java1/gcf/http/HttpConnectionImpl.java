...
public class HttpConnectionImpl
    ...
    public void open(String url, int mode, boolean timeouts)
        throws IOException {
    		...
    		String proxy = ApplicationManager.manager.getProperty("me4se.httpproxy");
    		...
    		if(proxy == null){
    			...
    			con = (HttpURLConnection) new URL(proxy).openConnection();
    		}
        ...
        con.setRequestProperty("User-Agent", ApplicationManager.manager.getProperty("me4se.useragent", 
        			ApplicationManager.manager.getProperty("microedition.platform", "MobileRunner-J2ME")));
